...
import org.oregano.oregano3.databinding.RequestListBinding
import org.oregano.oregano3.databinding.TransactionDetailBinding
import org.oregano.oregano3.databinding.TransactionsBinding
    ...
    override fun onShowDialog() {
        ...
        if (fee == null) {
            ...
            binding.tvFee.text = String.format("%s (%s)",
                                       getString(R.string.fix_per, feeSpb),
